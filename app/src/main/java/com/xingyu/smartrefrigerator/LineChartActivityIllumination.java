...
public class LineChartActivityIllumination extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_chart_illumination);
        ...
        for (int i = 0; i < dataJsonStreams.size(); i++) {
            Log.w("lll", "光照折线图循环次数= " + i);
            String dataJson_id = dataJsonStreams.get(i).getId();
            if (dataJson_id.equals(Illumination)) {
                Log.w("lll", "光照折线图");
        ...
        showLineChart(points,"光照强度", Color.CYAN);
