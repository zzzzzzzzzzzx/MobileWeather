...
public class LineChartActivityUltraviolet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_chart_ultraviolet);
        ...
        for (int i = 0; i < dataJsonStreams.size(); i++) {
            Log.w("lll", "紫外线折线图循环次数= " + i);
            String dataJson_id = dataJsonStreams.get(i).getId();
            if (dataJson_id.equals(Ultraviolet)) {
                Log.w("lll", "紫外线折线图");
        ...
        showLineChart(points,"紫外线", Color.CYAN);
