...
public class LineChartActivityPressure extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_chart_pressure);
        ...
        for (int i = 0; i < dataJsonStreams.size(); i++) {
            Log.w("lll", "大气压折线图循环次数= " + i);
            String dataJson_id = dataJsonStreams.get(i).getId();
            if (dataJson_id.equals(Pressure)) {
                Log.w("lll", "大气压折线图");
        ...
        showLineChart(points,"大气压", Color.CYAN);
