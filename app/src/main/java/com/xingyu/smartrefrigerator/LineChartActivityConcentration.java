...
public class LineChartActivityConcentration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_chart_concentration);
        ...
        for (int i = 0; i < dataJsonStreams.size(); i++) {
            Log.w("lll", "PM2.5折线图循环次数= " + i);
            String dataJson_id = dataJsonStreams.get(i).getId();
            if (dataJson_id.equals(Concentration)) {
                Log.w("lll", "PM2.5折线图");
        ...
        showLineChart(points,"PM2.5", Color.CYAN);
